...
from UDP.synagogue import Nosah
from UDP.synagogue import City
...
class QueryPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.TCombobox_query_nosah.set(Nosah.ASHCANZE.name)
        ...
        self.Button_query_search.configure(command=lambda: proj_support.send_query(self.TEntry_query_query.get(),
                                                                                   Nosah.__getitem__(
