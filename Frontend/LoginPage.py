...
class LoginPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.Label_login_title.place(relx=0.417, rely=0.111, height=41, width=319)
        ...
        self.TEntry_login_ID.place(relx=0.467, rely=0.267, relheight=0.069, relwidth=0.423)
        ...
        self.TEntry_login_Password.place(relx=0.467, rely=0.378, relheight=0.069, relwidth=0.423)
        ...
        self.Button_login_gabai.place(relx=0.583, rely=0.556, height=43, width=113)
        ...
        self.Button_login_guest.place(relx=0.25, rely=0.556, height=43, width=113)
