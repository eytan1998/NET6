...
class ViewGabaiPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.Label_viewsgabai_name.place(relx=0.067, rely=0.132, height=31, width=49)
        ...
        self.TEntry_viewgabai_name.place(relx=0.3, rely=0.132, relheight=0.046, relwidth=0.623)
        ...
        self.Label_viewgabai_ID.place(relx=0.083, rely=0.243, height=41, width=59)
        ...
        self.Label_viewgabai_pass.place(relx=0.05, rely=0.375, height=41, width=89)
        ...
        self.Label_viewgabai_phone.place(relx=0.067, rely=0.508, height=41, width=109)
        ...
        self.TEntry_viewgabai_phone.place(relx=0.3, rely=0.53, relheight=0.046, relwidth=0.623)
        ...
        self.Button_viewgabai_save.place(relx=0.417, rely=0.883, height=43, width=113)
        ...
        self.TEntry_viewgabai_pass.place(relx=0.3, rely=0.397, relheight=0.046, relwidth=0.623)
        ...
        self.TEntry_viewgabai_ID.place(relx=0.3, rely=0.265, relheight=0.046, relwidth=0.623)
