...
from Backend.Help.synagogue import Nosah
from Backend.Help.synagogue import City
...
class QueryPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.Scrolledlistbox_query.place(relx=0.033, rely=0.308, relheight=0.5, relwidth=0.943)
        ...
        self.TCombobox_query_city.place(relx=0.5, rely=0.176, relheight=0.046, relwidth=0.245)
        ...
        self.Button_query_search.configure(
            command=lambda: proj_support.send_query(controller, self.TEntry_query_query.get(),
                                                    Nosah.__getitem__(
        ...
        self.Button_query_View.place(relx=0.417, rely=0.879, height=43, width=113)
