...
class ManageGabaiPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.Scrolledlistbox_mngabai.place(relx=0.083, rely=0.111
        ...
        self.Button_mngabai_del.place(relx=0.667, rely=0.822, height=43
                , width=143)
        ...
        self.Button_mngabai_edit.place(relx=0.383, rely=0.822, height=43
                , width=143)
